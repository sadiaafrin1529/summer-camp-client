const Contact = () => {
    return (
      <section className="py-6 dark:bg-gray-800 dark:text-gray-50">
        <div className=" mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col justify-center lg:text-left">
            <p className="mb-1 text-sm font-medium  uppercase dark:text-violet-400">
              Download our app and enjoy All Course from home
            </p>
            <h1 className="py-2 text-3xl font-medium  title-font">
              Most Reliable Arts & craft Courses
            </h1>
          </div>
